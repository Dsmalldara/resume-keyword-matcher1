 ...
 */
import type { PostAuthVerifyResetToken200User } from "./postAuthVerifyResetToken200User";

export type PostAuthVerifyResetToken200 = {
  valid?: boolean;
  user?: PostAuthVerifyResetToken200User;
};
