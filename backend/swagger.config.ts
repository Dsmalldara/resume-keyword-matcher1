...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    servers: [
      ...
      {
        url: "https://resume-checker.fly.dev",
        ...
        AnalysisResult: {
          ...
          properties: {
            matchScore: {
              type: "number",
              example: 87.5,
              description: "Overall compatibility score between resume and job",
            },
            summary: {
              type: "string",
  ...
  apis: [
    ...
    "./dist/src/routes/*.js",
    "./dist/src/routes/auth/routes/*.js",
    "./dist/src/routes/coverletters/routes/*.js",
    "./dist/src/routes/resumes/*.js",
    "./dist/src/routes/analysis/routes/*.js",
    "./dist/src/routes/insights/routes/*.js",
  ],
};
