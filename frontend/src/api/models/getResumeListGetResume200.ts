...
import type { GetResumeListGetResume200Pagination } from "./getResumeListGetResume200Pagination";

export type GetResumeListGetResume200 = {
  resumes?: Resume[];
  pagination?: GetResumeListGetResume200Pagination;
};
